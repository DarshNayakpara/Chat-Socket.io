                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="Open" role="tabpanel" aria-labelledby="Open-tab">
                        ...
                        <div class="chat-list">
                            ...
                            <div class="user_list  m-2 d-flex align-items-center" data-id="{{$user["id"]}} " >
                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                          <img class="img-fluid" src="https://ui-avatars.com/api/?name={{$userInfo["name"]}}?rounded=true" alt="user img">
                        </div>
                        <div class="flex-grow-1 ms-3">
                            @if($userInfo)
                            <h3>{{$userInfo["name"]}}</h3>
